...
Route::get('/matakuliah-praktikum', [MatakuliahController::class, 'index'])->name('matakuliah.index');
Route::get('/matakuliah-praktikum/{kode}', [MatakuliahController::class, 'show'])->name('matakuliah.show');